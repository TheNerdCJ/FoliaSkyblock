...
public class BazaarCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            player.sendMessage("§6=== Bazaar Commands ===");
            player.sendMessage("§e/bazaar buy <item> <amount> §7- Instant buy from Bazaar");
            player.sendMessage("§e/bazaar sell <item> <amount> §7- Instant sell to Bazaar");
            player.sendMessage("§e/bazaar orders <item> §7- View buy/sell orders");
            player.sendMessage("§e/bazaar createbuy <item> <amount> <price> §7- Create buy order");
            player.sendMessage("§e/bazaar createsell <item> <amount> <price> §7- Create sell order");
            return true;
        }
